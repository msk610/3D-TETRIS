 ...
 */
public class ThirdTut implements Screen {
    //Members
    Button music, sound;
    ...
    //Constructor
    public ThirdTut(Game game, AssetLoader assets, ButtonLoader buttons, PerspectiveCamera cam, ModelBatch batch,
    ...
    public void show() {
        ...
        //Set the image
        tutorialImage = new Image(assets.tut3);
        ...
        next = buttonLoader.generateForwardButton("Play");
        stage.addActor(back);
        stage.addActor(next);
