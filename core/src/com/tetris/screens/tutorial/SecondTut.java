 ...
 */
public class SecondTut implements Screen {
    //Members
    Button music, sound;
    ...
    //Constructor
    public SecondTut(Game game, AssetLoader assets, ButtonLoader buttons, PerspectiveCamera cam, ModelBatch batch,
    ...
    public void show() {
        ...
        //Set the image
        tutorialImage = new Image(assets.tut2);
        ...
        next.addListener(new InputListener() {
            ...
            public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
                ...
                game.setScreen(new ThirdTut(game,assets,buttonLoader,cam,modelBatch,music,sound));
                return true;
            }
        });
